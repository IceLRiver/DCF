...
def main():
    ...
    print('Device: ', device)
    data_folder = r' '
    exper_save_folder = r'exper7'
    os.makedirs(os.path.join(exper_save_folder, 'predict'), exist_ok=True)
    os.makedirs(os.path.join(exper_save_folder, 'predict', 'similarity'), exist_ok=True)
    ...
    plot_predict_loss_compare(losses_i, 'current', os.path.join(exper_save_folder, 'predict', 'similarity'), train, implicit)
    plot_predict_loss_compare(losses_iv, 'fusion', os.path.join(exper_save_folder, 'predict', 'similarity'), train, implicit)
    plot_predict_loss_compare(losses_v, 'voltage', os.path.join(exper_save_folder, 'predict', 'similarity'), train, implicit)
